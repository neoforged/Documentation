...
:::note
This file differs from that of the one in your mod's `resources/` directory. This file defines a brand new feature pack and as thus must be in its own folder.
:::
