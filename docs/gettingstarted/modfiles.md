...
| `services`           |  array  |  `[]`   |                                                                 JAR이 사용하는 서비스를 지정합니다. 네오 포지가 모드의 자바 모듈 정보를 만들 때 사용합니다.                                                                  | `services=["net.minecraftforge.forgespi.language.IModLanguageProvider"]` |
...
| `displayURL`    | string  |            *없음*             |                                                                       모드 목록에 표시할 모드 소개 페이지의 URL을 지정합니다.                                                                        | `displayURL="https://minecraftforge.net/"`                      |
...
| `mandatory`    | boolean |  **필수**   |                                종속성이 만족되지 않으면 오류가 발생해야 할지를 지정합니다.                                 | `mandatory=true`                             |
