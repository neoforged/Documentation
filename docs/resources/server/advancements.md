...
builder.rewards(
    ...
    .addLootTable(ResourceLocation.create("minecraft", "chests/igloo"))
    // Alternatively, use recipe() to create a new builder.
    .addRecipe(ResourceLocation.create("minecraft", "iron_ingot"))
    // Alternatively, use function() to create a new builder.
    .runs(ResourceLocation.create("examplemod", "example_function"))
);
...
builder.save(saver, ResourceLocation.create("examplemod", "example_advancement"), existingFileHelper);
```
