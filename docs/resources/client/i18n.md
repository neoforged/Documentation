---
description: This article explains how Minecraft implements I18n (internationalization) and L10n (localization), on both the code end and the data end.
sidebar_position: 1
---
# I18n and L10n
...
:::warning
Font description types other than `FontDescription.Resource` will throw an exception when used in a style. To make use of other or custom `FontDescription`s, create an supply an `ObjectInfo` to a component with `ObjectContents`.
:::
